...
func _on_signup_login_focus_entered():
	pass # Replace with function body.my_style.set_bg_color(Color(0.57,0.47,0.44,0.45))
	set("custom_styles/normal", my_style)
	# font color gets darker
	set("custom_colors/font_color",Color(0.9,0.78,0.84,1))

func _on_signup_login_focus_exited():
	my_style.set_bg_color(Color(0.57,0.47,0.44,0.17))
	# Set the "normal" style to be your newly created style.
	set("custom_styles/normal", my_style)
...
func _on_signup_login_mouse_entered():
...
func _on_signup_login_mouse_exited():
